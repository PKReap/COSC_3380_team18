The code begin submitted contains the frontend and backend. For the frontend it contains homepage.html homepage.js login.html login js homepage.css login.css admin.css admim.html and admin.js
